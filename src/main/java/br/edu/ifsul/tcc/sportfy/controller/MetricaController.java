...
public class MetricaController {
    ...
    public String excluirMetrica(@PathVariable("id") Long id,
                                 HttpSession session,
                                 RedirectAttributes ra) {
        Usuario usuarioLogado = (Usuario) session.getAttribute("usuarioLogado");
        if (usuarioLogado == null) return "redirect:/login";
    ...
    public String exibirFormularioEditar(@PathVariable("id") Long id,
                                         Model model,
                                         HttpSession session) {
        Usuario usuarioLogado = (Usuario) session.getAttribute("usuarioLogado");
        if (usuarioLogado == null) return "redirect:/login";
    ...
    public String processarEdicaoMetrica(@PathVariable("id") Long id,
